...
def main():
    # test_linear_search(10000, 1800, ordered=False)
...
def test_median(N, num_trials):
    ...
    print("N=" + str(N) + ",",
          "best=" + str(min_comps) + ",", "(expected", str(N)+"),",
          "worst=" + str(max_comps) + ",","(expected", str(N**2)+"),",
          "avg=" + str(total_comps/num_trials), "(expected", str(math.ceil(N**2/2))+")")
